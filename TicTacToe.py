...
class WinCondition:
    ...
    def check_diagonals(self, z):
        ...
        if all(
            self.board[3 - reverse_diag][reverse_diag][z] == self.win_player
            for reverse_diag in range(4)
        ):
            return True
    ...
    def check_vertical_xdiagonals(self, x):
        ...
        if all(
            self.board[x][reverse_diag][3 - reverse_diag] == self.win_player
            for reverse_diag in range(4)
        ):
            return True
    ...
    def check_vertical_ydiagonals(self, y):
        ...
        if all(
            self.board[reverse_diag][y][3 - reverse_diag] == self.win_player
            for reverse_diag in range(4)
        ):
            return True
